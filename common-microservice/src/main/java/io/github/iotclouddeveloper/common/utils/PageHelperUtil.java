...
{
    public static <P extends io.github.iotclouddeveloper.common.dto.PageInfo, R> Page<R> getPage(final Function<P, List<R>> function, final P param) {
        return getPage(function, param, (Class<R>)null);
    }
    
    public static <P extends io.github.iotclouddeveloper.common.dto.PageInfo, I, R> Page<R> getPage(final Function<P, List<I>> function, final P param, final Class<R> resultClass) {
    ...
    public static <P extends io.github.iotclouddeveloper.common.dto.PageInfo, I, R> Page getPage(final BiFunction<com.baomidou.mybatisplus.extension.plugins.pagination.Page<I>, Wrapper<I>, IPage<I>> function, final P param, final Wrapper<I> wrapper, final Class<R> resultClass) {
